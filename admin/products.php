  ...
  if(isset($_GET['del'])){
    if($_GET['del'] == 'true'){
      ...
      if(mysqli_query($conn, $del_query)){
        ...
        header("Location: https://www.rinnai.com.pk/admin/products.php");
      } else {
    ...
    <div class="home-content width-100" style="width: 100% ;">
      <div class="sales-boxes width-100 " style="width: 100% ;">
        <div class="recent-sales box width-100" style="width: 100% ;">
          <div class="title w-100">Products <a href="add-product.php"><button class="d-inline-block btn btn-success" style="margin-left: calc(100% - 310px)">ADD PRODUCT</button></a></div>
                      ...
                      if(mysqli_num_rows($result) > 0){
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          <tr>
                            ...
                            <!-- <td><a href="categories.php?status=<?php echo $row['qty'] ?>&pid=<?php echo $row['pid'] ?>"><button class="btn btn-info px-3">Change Status</button></a></td> -->
