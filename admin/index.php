<?php
  ...
  $result = mysqli_query($conn, "SELECT * FROM `orders` WHERE `status`='placed'");
?>
<!DOCTYPE html>
    ...
    <div class="home-content width-100" style="width: 100% ;">
      <div class="sales-boxes width-100 " style="width: 100% ;">
        <div class="recent-sales box width-100" style="width: 100% ;">
          <div class="title w-100">Current Orders </div>
                                ...
                                while($rowww = mysqli_fetch_assoc($order_products)){
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php if($count2 == 0){ ?><a href="index.php?deliver=true&oid=<?php echo $row['oid'] ?>"><button class="btn btn-info px-3">Deliver</button></a><?php } ?></td>
